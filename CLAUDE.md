...
10. **무료/유료 경계.** 무료=진단·추천(설계안 Preview까지) / 유료=실행·운영. 실제 Company 생성은 결제 게이트 이후. [free-paid-boundary](docs/business/free-paid-boundary.md).
11. **Trust First.** 신뢰할 수 있는 결과만 제공. 부족하면 결과물을 만들지 말고 정보를 요청. 결과물은 Readiness/Confidence(≥90 최종/70–89 초안/<70 정보요청) 게이트와 [Output Scope](docs/specs/output-scope-spec.md)를 통과해야 한다. 모르면 묻고, 준비되면 실행, 결과 후 평가받고 성장.
