...
## 읽는 순서 (신규 기여자)
1. [ATLAS_CONSTITUTION](constitution/ATLAS_CONSTITUTION.md) + 개정 [#001](constitution/AMENDMENT-001-ai-employee-ecosystem.md)·[#002](constitution/AMENDMENT-002-company-centric-organization.md) → 우리가 누구인가
2. [architecture/01-organization-architecture](architecture/01-organization-architecture.md) → 조직 계층(Company→Dept→Employee→Skill)
3. [architecture/00-overview](architecture/00-overview.md) → 시스템이 어떻게 동작하는가
4. [specs/company-dna-spec](specs/company-dna-spec.md) → 회사란 무엇인가(최상위 객체)
